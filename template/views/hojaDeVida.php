...
<nav class="navbar navbar-expand-lg navbar-light bg-light container mb-4">
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="navbarNav">
      <div>
        <a class="btn" href="listaEstudiantes.php"><i class="fas fa-undo-alt"></i> VOLVER</a>
      </div>
    </div>
    <div>
      <?php
      ...
      <div class="accordion-body">
        ...
        <div class="row pt-2 text-center">
          ...
          <div class="col-4">
            ...
            <a class="btn btn-primary" href="../../controlador/descargarHoja.php?user=<?php echo $cedula ?>"><i class="far fa-file-word"> Generar Archivo</a></i>
          </div>
          <div class="col-4"></div>
        </div>
