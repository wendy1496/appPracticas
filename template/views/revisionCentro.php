...
<nav class="navbar navbar-expand-lg navbar-light bg-light container mb-4">
  <div class="container-fluid">
    ...
    <div>
      <a class="btn" href="listaRevision.php"><i class="fas fa-undo-alt"></i> VOLVER</a>
    </div>
  </div>
  <div>
    <?php
  ...
  <div class="accordion-item">
    ...
    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <form action="../../controlador/anexosRevision.php" method="post"  enctype="multipart/form-data" class="img-form">
          <div class="overlay">
               <div class="container">
          ...
          if ($fila=$consulta->fetch(PDO::FETCH_ASSOC)){ 
              ...
              $sql1="SELECT * FROM tbllistaanexos ORDER BY orden  ";  
                  ...
                  while ($fila1=$consulta1->fetch(PDO::FETCH_ASSOC)){ 
                      ...
                      include "../../controlador/anexosRevisionCentro.php" ; 
                  }
...
<div class="row pt-2 pb-2">
                <div class="col-xl-4 col-sm-6">
                  <label for="formGroupExampleInput" class="form-label required text-dark">¿Quién Aprueba?</label>
